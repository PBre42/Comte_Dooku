...
%% Create a GUI window 
window = figure('position',[0 0 900 500],...
                'unit','pixels',...
                'name','Sudoko Solver',...
                'visible','on');
...
sudokugui.delete = uicontrol("Style","pushbutton", ...
                             "String","Delete", ...
                             "Position",[550 15 100 30], ...
                             "Callback",{@sDelete,window});
...
%% Button for loading a grid from a picture
sudokugui.load = uicontrol("Style","pushbutton", ...
                           "String","Load Image", ...
                           "Position",[700 45 100 30], ...
                           "Callback",{@sLoad,window});
