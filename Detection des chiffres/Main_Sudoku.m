...
%% Passage en N&B
BW = ~imbinarize(rgb2gray(I_size),'adaptive','ForegroundPolarity','dark','Sensitivity',0.4);
figure (3)
...
Width = (xMax-xMin);
Height =(yMax-yMin);
I_crop = imcrop(I_size,[xMin yMin Width Height]);
figure
imshow(I_crop);

%% Remplir chiffre 
[Plocal test]=Identifier_Nombre(I_crop);
figure
